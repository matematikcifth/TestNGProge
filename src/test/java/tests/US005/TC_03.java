...
public class TC_03 extends ExtentReport {
    ...
    public void test03() {
            ...
            alloverCommercePage.currentPassword.sendKeys(ConfigReader.getProperty("password"), Keys.TAB, ConfigReader.getProperty("password"), Keys.TAB, ConfigReader.getProperty("password"));
            extentTest.info("new password dogrulandi");



            //HATALI KISIM--Click on "save change"button tiklanmadi
